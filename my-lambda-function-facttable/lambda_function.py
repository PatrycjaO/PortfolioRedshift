...
def lambda_handler(event, context):
    ...
    copy = "COPY wind.facttable FROM 's3://" +os.environ.get("BUCKET") +"/lookup_table/locations.csv' IAM_ROLE '" +os.environ.get("ARNRSS3") +"' DELIMITER ',' CSV IGNOREHEADER AS 1 IGNOREBLANKLINES;"
